...
const argv = yargs.options({
    ...
    'spec': {
        ...
        default: 'cypress/integration/vf/*.spec.js'
    }
}).help()
  .argv

const reportDir = path.join(__dirname , cypressConfig.reporterOptions.reportDir)
console.log(reportDir)
const reportFiles = `${reportDir}/*.json`
const assetsFolder = `${reportDir}/assets/*`
